...
| v0.7.9 | Swiss Bridge advice and SMTP diagnostics before public alpha |
...
| v0.7.9 | Advice includes Swiss Bridge liquidity tiers and admin SMTP test failures remain JSON-diagnosable |
